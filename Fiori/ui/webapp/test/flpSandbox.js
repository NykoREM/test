			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5ui-display": {
								"semanticObject": "ui5ui",
								"action": "display",
								"description": "A Fiori application accademy 2022.",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									"applicationType": "SAPUI5",
									"additionalInformation": "SAPUI5.Component=ui5.ui",
									"url": sap.ui.require.toUrl("ui5/ui")
								}
							}
						}
					}
